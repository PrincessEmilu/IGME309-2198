...
class MyCamera
{
	// Forward, right and up for world
	vector3 m_v3Position = vector3(0.0f, 0.0f, 10.0f); //Where my camera is located
	vector3 m_v3Target = vector3(0.0f, 0.0f, 0.0f); //What I'm looking at
	vector3 m_v3Above = vector3(0.0f, 1.0f, 0.0f); //What is above the camera

	// The relative directions for the camera
	vector3 m_v3Forward = vector3(0.0f, 0.0f, -1.0f); // Relative forward
	vector3 m_v3Right = vector3(-1.0f, 0.0f, 0.0f); // Relative right
	vector3 m_v3Up = vector3(0.0f, -1.0f, 0.0f); // Relative Up
