...
void Simplex::MyCamera::SetRight(vector3 right)
{
	m_v3Right = right;
}
...
// Move the given distance, relative to the camera's understanding of where "forward" is
...
// Move the given distance, relative to the camera's understanding of where "up" is
...
// Move the given distance, relative to the camera's understanding of where "right" is
