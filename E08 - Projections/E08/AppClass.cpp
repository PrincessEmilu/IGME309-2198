...
void Application::InitVariables(void)
{
	...
	m_sProgrammer = "Emily Horton - eh8582@rit.edu";
...
void Application::Display(void)
{
	...
	case 3:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(AXIS_X * 20.0f, ZERO_V3, (-1 * AXIS_Z));
		break;
	case 4:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(-1 * (AXIS_Z * 15.0f), ZERO_V3, AXIS_Y);
		break;
	case 5:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(-1 * (AXIS_Z * 15.0f), ZERO_V3, AXIS_Y);
	...
	case 7:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(AXIS_Z * 10.0f, ZERO_V3, (-1 * AXIS_Y));
		break;
	}
